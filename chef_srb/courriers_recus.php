...
$courriers = $db->query("SELECT * FROM courriers WHERE service_cible = 'SRB' ORDER BY created_at DESC")->fetchAll();
  ...
  <table>
    ...
    <tbody>
      <?php if (empty($courriers)): ?>
        <tr class="empty-row"><td colspan="6">Aucun courrier reçu pour le SRB.</td></tr>
