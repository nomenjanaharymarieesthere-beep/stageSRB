...
$navByRole = [
    ...
    'drbf' => [
        ...
        ['key' => 'valider', 'label' => 'Valider les courriers (final)', 'href' => '/drbf/valider_courrier.php', 'icon' => '✅'],
    ...
    'chef_srb' => [
        ...
        ['key' => 'transmettre', 'label' => 'Transmettre au DRBF', 'href' => '/chef_srb/transmettre_drbf.php', 'icon' => '✅'],
    ...
    'chef_srsp' => [
        ...
        ['key' => 'transmettre', 'label' => 'Transmettre au DRBF', 'href' => '/chef_srsp/transmettre_drbf.php', 'icon' => '✅'],
    ...
    'srpe' => [
        ...
        ['key' => 'transmettre', 'label' => 'Transmettre au DRBF', 'href' => '/srpe/transmettre_drbf.php', 'icon' => '✅'],
