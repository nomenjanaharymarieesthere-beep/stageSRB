...
$courriers = $db->query("SELECT * FROM courriers WHERE statut != 'nouveau' ORDER BY created_at DESC")->fetchAll();
...
<div class="panel">
  <h3>Tous les courriers reçus du Secrétariat</h3>
  <table>
    <thead><tr><th>Référence</th><th>Objet</th><th>Expéditeur</th><th>PDF</th><th>Statut</th></tr></thead>
    <tbody>
      <?php if (empty($courriers)): ?>
        <tr class="empty-row"><td colspan="5">Aucun courrier reçu.</td></tr>
