...
$aSigner = $db->query("SELECT COUNT(*) c FROM courriers WHERE statut = 'valide'")->fetch()['c'];
...
<div class="stats-grid">
  ...
  <div class="stat-card c-green"><div class="num"><?= $aSigner ?></div><div class="lbl">Validés — à faire signer</div></div>
  <div class="stat-card c-indigo"><div class="num"><?= $archives ?></div><div class="lbl">Traités &amp; archivés</div></div>
</div>

<div class="panel">
  <h3>Derniers courriers enregistrés</h3>
  <table>
    <thead><tr><th>Référence</th><th>Objet</th><th>Expéditeur</th><th>Date réception</th><th>Statut</th></tr></thead>
    <tbody>
      <?php if (empty($recents)): ?>
        <tr class="empty-row"><td colspan="5">Aucun courrier enregistré pour le moment.</td></tr>
